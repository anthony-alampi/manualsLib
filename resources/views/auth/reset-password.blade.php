...
@section('content')
        <div class=" signup custom-position-password-form modify-password-container ">
            ...
            <form class="updated-password-form" method="POST" action="{{route('password.update')}}">
                ...
                <input type="hidden" name="email" autocomplete="on" placeholder="Email address" value="{{ $request->email}}">
